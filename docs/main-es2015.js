...
/* harmony import */ var _view_call_in_use_call_in_use_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/call-in-use/call-in-use.component */ "./src/app/view/call-in-use/call-in-use.component.ts");
/* harmony import */ var _view_call_list_call_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view/call-list/call-list.component */ "./src/app/view/call-list/call-list.component.ts");
...
const routes = [
    { path: '', component: _view_call_list_call_list_component__WEBPACK_IMPORTED_MODULE_4__["CallListComponent"] },
    { path: 'calls/:id', component: _view_call_in_use_call_in_use_component__WEBPACK_IMPORTED_MODULE_3__["CallInUseComponent"] },
];
...
/* harmony import */ var _view_call_list_call_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/call-list/call-list.component */ "./src/app/view/call-list/call-list.component.ts");
/* harmony import */ var _view_call_in_use_call_in_use_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/call-in-use/call-in-use.component */ "./src/app/view/call-in-use/call-in-use.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _view_call_list_call_list_component__WEBPACK_IMPORTED_MODULE_6__["CallListComponent"],
            _view_call_in_use_call_in_use_component__WEBPACK_IMPORTED_MODULE_7__["CallInUseComponent"],
        ],
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "callsData", function() { return callsData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "customersData", function() { return customersData; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CallInUseComponent", function() { return CallInUseComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var src_app_data_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/data/data */ "./src/app/data/data.ts");





let CallInUseComponent = class CallInUseComponent {
    constructor(route) {
        this.route = route;
    ...
    update() {
        ...
        const oldCustomer = src_app_data_data__WEBPACK_IMPORTED_MODULE_4__["customersData"].find(customer => customer.id == newCustomer.id);
        const oldCall = src_app_data_data__WEBPACK_IMPORTED_MODULE_4__["callsData"].find(call => call.customerId == newCustomer.id);
    ...
    completeCall() {
        const oldCall = src_app_data_data__WEBPACK_IMPORTED_MODULE_4__["callsData"].find(call => call.customerId == this.customer.id);
        if (oldCall)
            oldCall.callStatus = "Completed";
    }
};
CallInUseComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
CallInUseComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-call-in-use',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./call-in-use.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/view/call-in-use/call-in-use.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./call-in-use.component.css */ "./src/app/view/call-in-use/call-in-use.component.css")).default]
    })
], CallInUseComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_data_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/data/data */ "./src/app/data/data.ts");



let CallListComponent = class CallListComponent {
    constructor() {
    ...
    searchCall(callParam) {
        const searchParam = callParam.value;
        this.searchResults = this.calls.filter(call => {
            const hasType = call.type == searchParam.type || !searchParam.type;
            const hasStatus = call.callStatus == searchParam.callStatus || !searchParam.callStatus;
            const withinDateRange = (call.date >= searchParam.startDate || !searchParam.startDate)
                && (call.date <= searchParam.endDate || !searchParam.endDate);
            if (hasType && hasStatus && withinDateRange)
                return call;
        });
        this.dataSource = this.searchResults;
...
CallListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-call-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./call-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/view/call-list/call-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./call-list.component.css */ "./src/app/view/call-list/call-list.component.css")).default]
    })
], CallListComponent);
...
module.exports = __webpack_require__(/*! C:\Users\sontu\OneDrive\Documents\mazda-phone-calls\src\main.ts */"./src/main.ts");
